 ...
 * M930 - TMC set blank_time. (Requires TMC_CHOP_CALIBRATION)
 * M931 - TMC set off_time. (Requires TMC_CHOP_CALIBRATION)
 * M932 - TMC set hysteresis_start. (Requires TMC_CHOP_CALIBRATION)
 * M933 - TMC set hysteresis_end/sine_offset (chm = 0/1). (Requires TMC_CHOP_CALIBRATION)
 * M934 - TMC set fast_decay_time (chm = 1). (Requires TMC_CHOP_CALIBRATION)
 * M935 - TMC set disable_I_comparator (chm = 1). (Requires TMC_CHOP_CALIBRATION)
 * M936 - TMC set stealth_gradient. (Requires TMC_CHOP_CALIBRATION)
 * M937 - TMC set stealth_amplitude. (Requires TMC_CHOP_CALIBRATION)
 * M938 - TMC set stealth_freq. (Requires TMC_CHOP_CALIBRATION)
 * M939 - TMC switch stealth_autoscale. (Requires TMC_CHOP_CALIBRATION)
 * M941 - TMC set MSLUT. (Requires TMC_MSLUT_CALIBRATION)
 * M942 - TMC reset MSLUT. (Requires TMC_MSLUT_CALIBRATION)
 * M943 - TMC set preset MSLUT. (Requires TMC_MSLUT_CALIBRATION)
 * M945 - TMC switch StealthChop. (Requires TMC_CHOP_MODE)
 * M946 - TMC switch ChopperMode. (Requires TMC_CHOP_MODE)
 * M947 - TMC switch interpolation. (Requires TMC_CHOP_MODE)
 *
