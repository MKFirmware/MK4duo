...
//
  ...
  void tmc2130_init() {
    ...
    #endif
    #if ENABLED(E1_IS_TMC2130)
      { _TMC2130_INIT(E1, steps_per_mm[E_AXIS + 1]); }
    #endif
    #if ENABLED(E2_IS_TMC2130)
      { _TMC2130_INIT(E2, steps_per_mm[E_AXIS + 2]); }
    #endif
    #if ENABLED(E3_IS_TMC2130)
      { _TMC2130_INIT(E3, steps_per_mm[E_AXIS + 3]); }
    #endif
    #if ENABLED(E4_IS_TMC2130)
      { _TMC2130_INIT(E4, steps_per_mm[E_AXIS + 4]); }
    #endif
    #if ENABLED(E5_IS_TMC2130)
      { _TMC2130_INIT(E5, steps_per_mm[E_AXIS + 5]); }
    #endif
