...
#define CUSTOM_MACHINE_NAME "Kossel Team"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 90, 625, 625, 625}
...
#define X_PROBE_OFFSET_FROM_NOZZLE  19.9     // X offset: -left  [of the nozzle] +right
#define Y_PROBE_OFFSET_FROM_NOZZLE -11.5    // Y offset: -front [of the nozzle] +behind
