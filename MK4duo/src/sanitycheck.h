 ...
 */
  ...
  #if HOTEND_0_AUTO_FAN_PIN == FAN_PIN
    #error CONFLICT ERROR: You cannot set HOTEND_0_AUTO_FAN_PIN equal to FAN_PIN.
  #elif HOTEND_1_AUTO_FAN_PIN == FAN_PIN
    #error CONFLICT ERROR: You cannot set HOTEND_1_AUTO_FAN_PIN equal to FAN_PIN.
  #elif HOTEND_2_AUTO_FAN_PIN == FAN_PIN
    #error CONFLICT ERROR: You cannot set HOTEND_2_AUTO_FAN_PIN equal to FAN_PIN.
  #elif HOTEND_3_AUTO_FAN_PIN == FAN_PIN
    #error CONFLICT ERROR: You cannot set HOTEND_3_AUTO_FAN_PIN equal to FAN_PIN.
  #endif
#endif
...
#if ENABLED(HOTEND_AUTO_FAN) && !PIN_EXISTS(HOTEND_0_AUTO_FAN) && !PIN_EXISTS(HOTEND_1_AUTO_FAN) && !PIN_EXISTS(HOTEND_2_AUTO_FAN) && !PIN_EXISTS(HOTEND_3_AUTO_FAN)
