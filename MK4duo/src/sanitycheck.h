...
#endif
#if DISABLED(Z3_MIN_ENDSTOP_LOGIC) && NOMECH(DELTA) && !IS_SCARA
  #error DEPENDENCY ERROR: Missing setting Z3_MIN_ENDSTOP_LOGIC
#endif
#if DISABLED(Z4_MIN_ENDSTOP_LOGIC) && NOMECH(DELTA) && !IS_SCARA
...
#endif
#if DISABLED(Z3_MAX_ENDSTOP_LOGIC) && NOMECH(DELTA) && !IS_SCARA
  #error DEPENDENCY ERROR: Missing setting Z3_MAX_ENDSTOP_LOGIC
#endif
#if DISABLED(Z4_MAX_ENDSTOP_LOGIC) && NOMECH(DELTA) && !IS_SCARA
