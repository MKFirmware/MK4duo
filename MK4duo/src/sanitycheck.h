...
// Buffer
  ...
  #error DEPENDENCY ERROR: You must enabled SDSUPPORT for SERIAL_STATS_MAX_RX_QUEUED
#endif
#if DISABLED(SDSUPPORT) && ENABLED(SERIAL_STATS_DROPPED_RX)
  #error DEPENDENCY ERROR: You must enabled SDSUPPORT for SERIAL_STATS_DROPPED_RX
#endif
