 ...
 */
  ...
  inline void gcode_M223() {
    ...
    filamentrunout.sensor.setLogic((FilRunoutEnum)tools.data.extruder.target, parser.value_bool());
  ...
  inline void gcode_M224() {
    ...
    filamentrunout.sensor.setPullup((FilRunoutEnum)tools.data.extruder.target, parser.value_bool());
