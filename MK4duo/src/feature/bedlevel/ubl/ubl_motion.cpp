...
#include "../../../../MK4duo.h"
  ...
  void unified_bed_leveling::line_to_destination_cartesian(const float &feed_rate, uint8_t extruder) {
    ...
    bool _O2 unified_bed_leveling::prepare_segmented_line_to(const float rtarget[XYZE], const float &feedrate) {
      ...
      const float tot_dx = rtarget[X_AXIS] - mechanics.current_position[X_AXIS],
                  tot_dy = rtarget[Y_AXIS] - mechanics.current_position[Y_AXIS],
                  tot_dz = rtarget[Z_AXIS] - mechanics.current_position[Z_AXIS],
                  tot_de = rtarget[E_AXIS] - mechanics.current_position[E_AXIS];
      ...
      float seg_rx = mechanics.current_position[X_AXIS],
            seg_ry = mechanics.current_position[Y_AXIS],
            seg_rz = mechanics.current_position[Z_AXIS],
