...
// Utility
#define HAS_DOOR            (ENABLED(DOOR_OPEN) && PIN_EXISTS(DOOR_OPEN))
...
#endif
#if DISABLED(ENDSTOPPULLUP_Z4MIN)
...
#endif
#if DISABLED(ENDSTOPPULLUP_Z4MAX)
...
#endif
#if DISABLED(Z4_MIN_ENDSTOP_LOGIC)
...
#endif
#if DISABLED(Z4_MAX_ENDSTOP_LOGIC)
 ...
 */
  ...
  #define FAN4_CHANNEL FAN2_COMMA FAN4_PIN
  #define FAN4_COMMA ,
#else
  #define FAN4_COUNT 0
  #define FAN4_INDEX
  ...
  #define FAN5_CHANNEL FAN2_COMMA FAN5_PIN
  #define FAN5_COMMA ,
#else
  #define FAN5_COUNT 0
  #define FAN5_INDEX
