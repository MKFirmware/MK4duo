...
#define MIN_PULSE_TICKS ((MINIMUM_STEPPER_PULSE) * (STEPPER_TIMER_TICKS_PER_US))
#define ADD_PULSE_TICKS ((MIN_STEPPER_PULSE_CYCLES) / (STEPPER_TIMER_PRESCALE) - MIN_PULSE_TICKS)
