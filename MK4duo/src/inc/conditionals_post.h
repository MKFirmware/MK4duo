...
#define HAS_COOLER   (TEMP_SENSOR_COOLER != 0 && PIN_EXISTS(COOLER))
...
#define HAS_THERMALLY_PROTECTED_COOLER  (HAS_TEMP_COOLER && HAS_COOLER && THERMAL_PROTECTION_COOLER)
 ...
 */
  ...
  #define COOLER_CHANNEL  CHAMBER_COMMA COOLER_PIN
  #define COOLER_COMMA ,
#else
