...
#define HAS_SENSORLESS      (HAS_STALLGUARD && (ENABLED(SENSORLESS_HOMING) || ENABLED(Z_PROBE_SENSORLESS)))
...
// Disable Z axis sensorless homing if a probe is used to home the Z axis
  ...
  #endif
  #define X_SENSORLESS (X_HAS_STALLGUARD && ENABLED(X_STALL_SENSITIVITY))
  #define Y_SENSORLESS (Y_HAS_STALLGUARD && ENABLED(Y_STALL_SENSITIVITY))
  #define Z_SENSORLESS (Y_HAS_STALLGUARD && ENABLED(Z_STALL_SENSITIVITY))
#else
