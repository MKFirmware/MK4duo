...
// Disable Z axis sensorless homing if a probe is used to home the Z axis
  ...
  #define X_SENSORLESS (X_IS_DRV(TMC2130) && ENABLED(X_HOMING_SENSITIVITY))
  #define Y_SENSORLESS (Y_IS_DRV(TMC2130) && ENABLED(Y_HOMING_SENSITIVITY))
  #define Z_SENSORLESS (Z_IS_DRV(TMC2130) && ENABLED(Z_HOMING_SENSITIVITY))
