...
// Heaters
#define HAS_HEATER_0        (HAS_TEMP_0 && PIN_EXISTS(HEATER_0))
#define HAS_HEATER_1        (HAS_TEMP_1 && PIN_EXISTS(HEATER_1))
#define HAS_HEATER_2        (HAS_TEMP_2 && PIN_EXISTS(HEATER_2))
#define HAS_HEATER_3        (HAS_TEMP_3 && PIN_EXISTS(HEATER_3))
#define HAS_HEATER_BED      (HAS_TEMP_BED && PIN_EXISTS(HEATER_BED))
#define HAS_HEATER_CHAMBER  (HAS_TEMP_CHAMBER && PIN_EXISTS(HEATER_CHAMBER))
#define HAS_HEATER_COOLER   (HAS_TEMP_COOLER && PIN_EXISTS(COOLER))
 ...
 * Heaters
 */
#if HAS_HEATER_0 || ENABLED(ARDUINO_ARCH_SAM)
  #define HOT0_COUNT 1
  #define HOT0_INDEX 0
  ...
  #define HOT0_COMMA
#endif
#if HAS_HEATER_1 || ENABLED(ARDUINO_ARCH_SAM)
  #define HOT1_COUNT 1
...
#endif
#if HAS_HEATER_2 || ENABLED(ARDUINO_ARCH_SAM)
  #define HOT2_COUNT 1
...
#endif
#if HAS_HEATER_3 || ENABLED(ARDUINO_ARCH_SAM)
  #define HOT3_COUNT 1
...
#endif
#if HAS_HEATER_BED || ENABLED(ARDUINO_ARCH_SAM)
  #define BED_COUNT 1
...
#endif
#if HAS_HEATER_CHAMBER || ENABLED(ARDUINO_ARCH_SAM)
...
#endif
#if HAS_HEATER_COOLER || ENABLED(ARDUINO_ARCH_SAM)
...
// TEMPERATURE
#if (HOTENDS > 0 && HAS_TEMP_0) || ENABLED(ARDUINO_ARCH_SAM)
...
#if (HOTENDS > 1 && HAS_TEMP_1) || ENABLED(ARDUINO_ARCH_SAM)
...
#if (HOTENDS > 2 && HAS_TEMP_2) || ENABLED(ARDUINO_ARCH_SAM)
...
#if (HOTENDS > 3 && HAS_TEMP_3) || ENABLED(ARDUINO_ARCH_SAM)
...
#if HAS_TEMP_BED || ENABLED(ARDUINO_ARCH_SAM)
...
#if HAS_TEMP_CHAMBER || ENABLED(ARDUINO_ARCH_SAM)
...
#if HAS_TEMP_COOLER || ENABLED(ARDUINO_ARCH_SAM)
  ...
  #define MCU_ANALOG_INDEX          HOT0_ANALOG_INPUTS+HOT1_ANALOG_INPUTS+HOT2_ANALOG_INPUTS+HOT3_ANALOG_INPUTS+BED_ANALOG_INPUTS+CHAMBER_ANALOG_INPUTS+COOLER_ANALOG_INPUTS+FILAMENT_ANALOG_INPUTS+POWER_ANALOG_INPUTS
  #define MCU_ANALOG_CHANNEL        POWER_ANALOG_COMMA ADC_TEMPERATURE_SENSOR
  #define MCU_ANALOG_COMMA          ,
#else
  #define MCU_ANALOG_INPUTS         0
  #define MCU_ANALOG_INDEX          -1
  #define MCU_ANALOG_CHANNEL
  #define MCU_ANALOG_COMMA          POWER_ANALOG_COMMA
#endif

#if ENABLED(ADC_KEYPAD) // Keypad for ANET board
  #define ADC_KEYPAD_ANALOG_INPUTS  1
  #define ADC_KEYPAD_ANALOG_INDEX   HOT0_ANALOG_INPUTS+HOT1_ANALOG_INPUTS+HOT2_ANALOG_INPUTS+HOT3_ANALOG_INPUTS+BED_ANALOG_INPUTS+CHAMBER_ANALOG_INPUTS+COOLER_ANALOG_INPUTS+FILAMENT_ANALOG_INPUTS+POWER_ANALOG_INPUTS+MCU_ANALOG_INPUTS
  #define ADC_KEYPAD_ANALOG_CHANNEL MCU_ANALOG_COMMA ADC_KEYPAD_PIN
  ...
  #define ADC_KEYPAD_ANALOG_COMMA   MCU_ANALOG_COMMA
#endif
