...
#define HAS_AUTO_FAN_0 (ENABLED(HOTEND_AUTO_FAN) && PIN_EXISTS(HOTEND_0_AUTO_FAN))
#define HAS_AUTO_FAN_1 (ENABLED(HOTEND_AUTO_FAN) && PIN_EXISTS(HOTEND_1_AUTO_FAN))
#define HAS_AUTO_FAN_2 (ENABLED(HOTEND_AUTO_FAN) && PIN_EXISTS(HOTEND_2_AUTO_FAN))
#define HAS_AUTO_FAN_3 (ENABLED(HOTEND_AUTO_FAN) && PIN_EXISTS(HOTEND_3_AUTO_FAN))
#define AUTO_1_IS_0 (HOTEND_1_AUTO_FAN_PIN == HOTEND_0_AUTO_FAN_PIN)
#define AUTO_2_IS_0 (HOTEND_2_AUTO_FAN_PIN == HOTEND_0_AUTO_FAN_PIN)
#define AUTO_2_IS_1 (HOTEND_2_AUTO_FAN_PIN == HOTEND_1_AUTO_FAN_PIN)
#define AUTO_3_IS_0 (HOTEND_3_AUTO_FAN_PIN == HOTEND_0_AUTO_FAN_PIN)
#define AUTO_3_IS_1 (HOTEND_3_AUTO_FAN_PIN == HOTEND_1_AUTO_FAN_PIN)
#define AUTO_3_IS_2 (HOTEND_3_AUTO_FAN_PIN == HOTEND_2_AUTO_FAN_PIN)
