...
#define AXIS_HAS_TMC(ST)          (ST##_HAS_DRV(TMC2130)  || ST##_HAS_DRV(TMC2160)  || ST##_HAS_DRV(TMC2208)|| ST##_HAS_DRV(TMC2660)|| ST##_HAS_DRV(TMC5130)|| ST##_HAS_DRV(TMC5160))
...
#define AXIS_HAS_SPI(ST)          (ST##_HAS_DRV(TMC2130)  || ST##_HAS_DRV(TMC2160)  || ST##_HAS_DRV(TMC2660)  || ST##_HAS_DRV(TMC5130)  || ST##_HAS_DRV(TMC5160))
...
#define AXIS_HAS_SQUARE_WAVE(ST)  (AXIS_HAS_TMC(ST)       && ENABLED(SQUARE_WAVE_STEPPING))
#define AXIS_HAS_NORMAL_DRV(ST)   (!AXIS_HAS_TMC(ST)      && !AXIS_DRV_TYPE(ST,L6470) && !AXIS_DRV_TYPE(ST,TMC26X) && HAS_##ST##_STEP)
