...
#include "../../base.h"
  ...
  Heater heaters[HEATER_COUNT] = {
    ...
    #if HAS_HEATER_0
      // Hotend 0
      { IS_HOTEND, HEATER_0_PIN, TEMP_0_PIN,
        #if HEATER_USES_MAX
          TEMP_CS0_PIN,
        #endif
        TEMP_SENSOR_0, 0, 0, PID_MIN, PID_MAX, 0, 0,
    ...
    #if HAS_HEATER_1
      // Hotend 1
      { IS_HOTEND, HEATER_1_PIN, TEMP_1_PIN,
        #if HEATER_USES_MAX
          TEMP_CS1_PIN,
        #endif
        TEMP_SENSOR_1, 0, 0, PID_MIN, PID_MAX, 0, 0,
    ...
    #if HAS_HEATER_2
      // Hotend 2
      { IS_HOTEND, HEATER_2_PIN, TEMP_2_PIN,
        #if HEATER_USES_MAX
          TEMP_CS2_PIN,
        #endif
        TEMP_SENSOR_2, 0, 0, PID_MIN, PID_MAX, 0, 0,
    ...
    #if HAS_HEATER_3
      // Hotend 3
      { IS_HOTEND, HEATER_3_PIN, TEMP_3_PIN,
        #if HEATER_USES_MAX
          TEMP_CS3_PIN,
        #endif
        TEMP_SENSOR_3, 0, 0, PID_MIN, PID_MAX, 0, 0,
