...
#line 31 // set __LINE__ to a known value for both passes
  ...
  REPORT_NAME_DIGITAL(E5_DIR_PIN, __LINE__ )
#endif
#if PIN_EXISTS(E5_ENABLE)
  REPORT_NAME_DIGITAL(E5_ENABLE_PIN, __LINE__ )
#endif
#if PIN_EXISTS(E5_STEP)
  REPORT_NAME_DIGITAL(E5_STEP_PIN, __LINE__ )
#endif
...
#endif
#if PIN_EXISTS(FAN0)
  REPORT_NAME_DIGITAL(FAN0_PIN, __LINE__ )
#endif
#if PIN_EXISTS(FAN1)
...
#endif
#if PIN_EXISTS(FAN4)
  REPORT_NAME_DIGITAL(FAN4_PIN, __LINE__ )
#endif
#if PIN_EXISTS(FAN5)
  REPORT_NAME_DIGITAL(FAN5_PIN, __LINE__ )
#endif
  ...
  REPORT_NAME_DIGITAL(HEATER_CHAMBER_PIN, __LINE__ )
#endif
#if PIN_EXISTS(HEATER_COOLER)
  REPORT_NAME_DIGITAL(HEATER_COOLER_PIN, __LINE__ )
#endif
#if PIN_EXISTS(HOME)
  REPORT_NAME_DIGITAL(HOME_PIN, __LINE__ )
#endif
#if ENABLED(EEPROM_I2C)
  REPORT_NAME_DIGITAL(EEPROM_I2C, __LINE__ )
#endif
...
#endif
#if ENABLED(STAT_LED_RED_LED) && STAT_LED_RED_LED >= 0
...
#endif
#if ENABLED(THERMO_CS1) &&  THERMO_CS1 >= 0
  REPORT_NAME_DIGITAL(THERMO_CS1, __LINE__ )
#endif
#if ENABLED(THERMO_CS2) &&  THERMO_CS2 >= 0
...
#endif
#if ENABLED(TLC_BLANK_PORT) &&  TLC_BLANK_PORT >= 0
...
#endif
#if ENABLED(TLC_CLOCK_PORT) &&  TLC_CLOCK_PORT >= 0
...
#endif
#if ENABLED(UI1) && UI1 >= 0
  REPORT_NAME_DIGITAL(UI1, __LINE__ )
#endif
#if ENABLED(UI2) && UI2 >= 0
