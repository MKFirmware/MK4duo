...
// Two Z steppers
  ...
  #elif ENABLED(Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS) && DISABLED(Z_THREE_STEPPER_DRIVERS)
    #error "Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS requires Z_THREE_STEPPER_DRIVERS."
  #endif
#endif
