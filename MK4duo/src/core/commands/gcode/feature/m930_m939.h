 ...
 */
  ...
  */
  ...
  inline void gcode_M935(void) {
    if (parser.seenval('X')) {
      #if X_IS_TRINAMIC
        tmc.set_disable_I_comparator(stepperX, parser.value_int());
      #endif
      #if X2_IS_TRINAMIC
        tmc.set_disable_I_comparator(stepperX2, parser.value_int());
      #endif
    }
    if (parser.seenval('Y')) {
      #if Y_IS_TRINAMIC
        tmc.set_disable_I_comparator(stepperY, parser.value_int());
      #endif
      #if Y2_IS_TRINAMIC
        tmc.set_disable_I_comparator(stepperY2, parser.value_int());
      #endif
    }
    if (parser.seenval('Z')) {
      #if Z_IS_TRINAMIC
        tmc.set_disable_I_comparator(stepperZ, parser.value_int());
      #endif
      #if Z2_IS_TRINAMIC
        tmc.set_disable_I_comparator(stepperZ2, parser.value_int());
      #endif
    }
    if (parser.seenval('E')) {
      #if E0_IS_TRINAMIC
        tmc.set_disable_I_comparator(stepperE0, parser.value_int());
      #endif
    }
    if (parser.seen('X')) {
      #if X_IS_TRINAMIC
