...
// Idle oozing prevent
    ...
    #error "DEPENDENCY ERROR: IDLE_OOZING_MINTEMP have to be greater than EXTRUDE_MINTEMP."
  #endif
#endif
...
// Extruder runout prevent
    ...
    #error "DEPENDENCY ERROR: EXTRUDER_RUNOUT_MINTEMP have to be greater than EXTRUDE_MINTEMP."
  #endif
#endif
...
// Extruder runout prevent is incompatible with idle oozing prevent
  ...
  #error "DEPENDENCY ERROR: EXTRUDER_RUNOUT_PREVENT and IDLE_OOZING_PREVENT are incopatible. Please comment one of them."
#endif
...
static_assert(1 >= 0
  ...
  #endif
  #if DISABLED(TOOL_CHANGE_FIL_SWAP_PURGE)
    #error "DEPENDENCY ERROR: TOOL_CHANGE_FIL_SWAP requires TOOL_CHANGE_FIL_SWAP_PURGE."
  #endif
  #if DISABLED(TOOL_CHANGE_FIL_SWAP_PRIME_SPEED)
    #error "DEPENDENCY ERROR: TOOL_CHANGE_FIL_SWAP requires TOOL_CHANGE_FIL_SWAP_PRIME_SPEED."
  #endif
  #if DISABLED(TOOL_CHANGE_FIL_SWAP_RETRACT_SPEED)
    #error "DEPENDENCY ERROR: TOOL_CHANGE_FIL_SWAP requires TOOL_CHANGE_FIL_SWAP_RETRACT_SPEED."
  #endif
#endif
