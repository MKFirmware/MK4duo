...
class Driver {
  ...
  public: /** Public Function */
    ...
    FORCE_INLINE bool enable_read()                   { HAL::digitalRead(data.pin.enable); }
    ...
    FORCE_INLINE bool dir_read()                      { HAL::digitalRead(data.pin.dir); }
    ...
    FORCE_INLINE bool step_read()                     { HAL::digitalRead(data.pin.step); }
