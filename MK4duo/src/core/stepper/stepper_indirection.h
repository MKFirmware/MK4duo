...
// X Stepper
  ...
  #elif AXIS_HAS_TMC(X) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
    #define X_ENABLE_INIT()           NOOP
...
#if AXIS_HAS_TMC(X) && ENABLED(SQUARE_WAVE_STEPPING)
...
// Y Stepper
  ...
  #elif AXIS_HAS_TMC(Y) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
    #define Y_ENABLE_INIT()           NOOP
...
#if AXIS_HAS_TMC(Y) && ENABLED(SQUARE_WAVE_STEPPING)
...
// Z Stepper
  ...
  #elif AXIS_HAS_TMC(Z) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
    #define Z_ENABLE_INIT()           NOOP
...
#if AXIS_HAS_TMC(Z) && ENABLED(SQUARE_WAVE_STEPPING)
...
// X2 Stepper
    ...
    #elif AXIS_HAS_TMC(X2) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
      #define X2_ENABLE_INIT()        NOOP
  ...
  #if AXIS_HAS_TMC(X2) && ENABLED(SQUARE_WAVE_STEPPING)
...
// Y2 Stepper
    ...
    #elif AXIS_HAS_TMC(Y2) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
      #define Y2_ENABLE_INIT()        NOOP
  ...
  #if AXIS_HAS_TMC(Y2) && ENABLED(SQUARE_WAVE_STEPPING)
...
// Z2 Stepper
    ...
    #elif AXIS_HAS_TMC(Z2) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
      #define Z2_ENABLE_INIT()        NOOP
  ...
  #if AXIS_HAS_TMC(Z2) && ENABLED(SQUARE_WAVE_STEPPING)
...
// Z3 Stepper
    ...
    #elif AXIS_HAS_TMC(Z3) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
      #define Z3_ENABLE_INIT()        NOOP
  ...
  #if AXIS_HAS_TMC(Z3) && ENABLED(SQUARE_WAVE_STEPPING)
...
// Z4 Stepper
  ...
  #if AXIS_HAS_TMC(Z4) && ENABLED(SQUARE_WAVE_STEPPING)
  ...
  #elif AXIS_HAS_TMC(E0) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
    #define E0_ENABLE_INIT()          NOOP
  ...
  #if AXIS_HAS_TMC(E0) && ENABLED(SQUARE_WAVE_STEPPING)
...
// E1 Stepper
  ...
  #elif AXIS_HAS_TMC(E1) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
    #define E1_ENABLE_INIT()          NOOP
...
#if AXIS_HAS_TMC(E1) && ENABLED(SQUARE_WAVE_STEPPING)
...
// E2 Stepper
  ...
  #elif AXIS_HAS_TMC(E2) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
    #define E2_ENABLE_INIT()          NOOP
...
#if AXIS_HAS_TMC(E2) && ENABLED(SQUARE_WAVE_STEPPING)
...
// E3 Stepper
  ...
  #elif AXIS_HAS_TMC(E3) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
    #define E3_ENABLE_INIT()          NOOP
...
#if AXIS_HAS_TMC(E3) && ENABLED(SQUARE_WAVE_STEPPING)
...
// E4 Stepper
  ...
  #elif AXIS_HAS_TMC(E4) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
    #define E4_ENABLE_INIT()          NOOP
...
#if AXIS_HAS_TMC(E4) && ENABLED(SQUARE_WAVE_STEPPING)
...
// E5 Stepper
  ...
  #elif AXIS_HAS_TMC(E5) && ENABLED(TMC_SOFTWARE_DRIVER_ENABLE)
    #define E5_ENABLE_INIT()          NOOP
...
#if AXIS_HAS_TMC(E5) && ENABLED(SQUARE_WAVE_STEPPING)
