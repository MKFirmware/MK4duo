...
#define BW(N) ((N + 7) / 8)
  ...
  /**
   * custom_statusscreen.h files can define:
   * - A custom logo image
...
//
  ...
  //
    ...
    #if MAX_HOTEND > MAX_HOTEND_BITMAPS
...
//
  ...
  #if (MAX_HOTEND == 3 || MAX_HOTEND == 4)
    // If more heaters or they're combined, 3 bytes
    #define STATUS_HEATERS_XSPACE 24
  #elif STATUS_LOGO_WIDTH > (LCD_PIXEL_WIDTH - (_EXTRA_WIDTH) - 26 * (MAX_HOTEND)) // 128 - (20 + 24 + 26) == 58
  ...
  //
    ...
    #define _HEATERS_WIDTH (MAX_HOTEND * (STATUS_HEATERS_XSPACE)) // as many hotends as possible
  ...
  #if (MAX_HOTEND > 1 && STATUS_LOGO_WIDTH && BED_OR_CHAMBER_OR_FAN) || (MAX_HOTEND >= 3 && !BED_OR_CHAMBER_OR_FAN)
    #define _STATUS_HEATERS_X(H,S,N) ((LCD_PIXEL_WIDTH - (H * (S + N)) - (_EXTRA_WIDTH) + (STATUS_LOGO_WIDTH)) / 2)
    #if STATUS_HOTEND1_WIDTH
      #if MAX_HOTEND > 2
        #define STATUS_HEATERS_X _STATUS_HEATERS_X(MAX_HOTEND, STATUS_HOTEND1_WIDTH, 6)
      #else
        #define STATUS_HEATERS_X _STATUS_HEATERS_X(MAX_HOTEND, STATUS_HOTEND1_WIDTH, 4)
      #endif
    #else
...
//
  ...
  constexpr uint8_t status_hotend_width[MAX_HOTEND] = ARRAY_N(MAX_HOTEND, STATUS_HOTEND1_WIDTH, STATUS_HOTEND2_WIDTH, STATUS_HOTEND3_WIDTH, STATUS_HOTEND4_WIDTH, STATUS_HOTEND5_WIDTH, STATUS_HOTEND6_WIDTH);
  ...
  constexpr uint8_t status_hotend_bytewidth[MAX_HOTEND] = ARRAY_N(MAX_HOTEND, STATUS_HOTEND1_BYTEWIDTH, STATUS_HOTEND2_BYTEWIDTH, STATUS_HOTEND3_BYTEWIDTH, STATUS_HOTEND4_BYTEWIDTH, STATUS_HOTEND5_BYTEWIDTH, STATUS_HOTEND6_BYTEWIDTH);
  #define STATUS_HOTEND_BYTEWIDTH(N) status_hotend_bytewidth[N]
    ...
    constexpr uint8_t status_hotend_x[MAX_HOTEND] = ARRAY_N(MAX_HOTEND, STATUS_HOTEND1_X, STATUS_HOTEND2_X, STATUS_HOTEND3_X, STATUS_HOTEND4_X, STATUS_HOTEND5_X, STATUS_HOTEND6_X);
    ...
    #define STATUS_HOTEND_X(N) STATUS_HOTEND1_X
      ...
      #endif
      constexpr uint8_t status_hotend_text_x[] = ARRAY_N(MAX_HOTEND, STATUS_HOTEND1_TEXT_X, STATUS_HOTEND2_TEXT_X, STATUS_HOTEND3_TEXT_X, STATUS_HOTEND4_TEXT_X, STATUS_HOTEND5_TEXT_X, STATUS_HOTEND6_TEXT_X);
  ...
  #endif
  #ifndef STATUS_HOTEND_TEXT_X
    #if MAX_HOTEND == 4 && STATUS_LOGO_WIDTH
