...
void menu_tmc();
  ...
  void menu_advanced_filament() {
    ...
    MENU_BACK(MSG_ADVANCED_SETTINGS);
      ...
      #else // EXTRUDERS > 1
        MENU_MULTIPLIER_ITEM_EDIT(float3, MSG_FILAMENT_UNLOAD, &advancedpause.data[tools.extruder.active].unload_length, 0, extrude_maxlength);
      ...
      #else // EXTRUDERS > 1
        MENU_MULTIPLIER_ITEM_EDIT(float3, MSG_FILAMENT_LOAD, &advancedpause.data[tools.extruder.active].load_length, 0, extrude_maxlength);
...
void menu_advanced_temperature() {
  ...
  #if EXTRUDERS > 1
    void _reset_e_acceleration_rate(const uint8_t e) { if (e == tools.extruder.active) _reset_acceleration_rates(); }
  ...
  void menu_advanced_velocity() {
    ...
    #if EXTRUDERS > 1
      MENU_MULTIPLIER_ITEM_EDIT(float3, MSG_VMAX MSG_E, &mechanics.data.max_feedrate_mm_s[E_AXIS + tools.extruder.active], 1, 999);
  ...
  void menu_advanced_acceleration() {
    ...
    #if EXTRUDERS > 1
      MENU_MULTIPLIER_ITEM_EDIT(float5, MSG_A_RETRACT MSG_E, &mechanics.data.retract_acceleration[tools.extruder.active], 100, 99000);
    ...
    #if EXTRUDERS > 1
      MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(long5_25, MSG_AMAX MSG_E, &mechanics.data.max_acceleration_mm_per_s2[E_AXIS + tools.extruder.active], 100, 99000, _reset_acceleration_rates);
  ...
  void menu_advanced_jerk() {
    ...
    MENU_BACK(MSG_MOTION);
        ...
        #if EXTRUDERS > 1
          MENU_MULTIPLIER_ITEM_EDIT(float3, MSG_VE_JERK MSG_E, &mechanics.data.max_jerk[E_AXIS + tools.extruder.active], 1, 990);
  ...
  void menu_advanced_steps_per_mm() {
    ...
    #if MECH(DELTA)
      MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float5, MSG_STEPS_PER_MM, &mechanics.data.axis_steps_per_mm[X_AXIS], 5, 9999, _mechanics_refresh_positioning);
    #else
      MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float5, MSG_ASTEPS, &mechanics.data.axis_steps_per_mm[X_AXIS], 5, 9999, _mechanics_refresh_positioning);
      MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float5, MSG_BSTEPS, &mechanics.data.axis_steps_per_mm[Y_AXIS], 5, 9999, _mechanics_refresh_positioning);
      MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float5, MSG_CSTEPS, &mechanics.data.axis_steps_per_mm[Z_AXIS], 5, 9999, _mechanics_refresh_positioning);
    #endif

    #if EXTRUDERS > 1
      MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float5, MSG_ESTEPS, &mechanics.data.axis_steps_per_mm[E_AXIS + tools.extruder.active], 5, 9999, _mechanics_refresh_positioning);
      MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float5, MSG_E1STEPS, &mechanics.data.axis_steps_per_mm[E_AXIS], 5, 9999, _mechanics_refresh_e0_positioning);
      MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float5, MSG_E2STEPS, &mechanics.data.axis_steps_per_mm[E_AXIS + 1], 5, 9999, _mechanics_refresh_e1_positioning);
      #if EXTRUDERS > 2
        MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float5, MSG_E3STEPS, &mechanics.data.axis_steps_per_mm[E_AXIS + 2], 5, 9999, _mechanics_refresh_e2_positioning);
        #if EXTRUDERS > 3
          MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float5, MSG_E4STEPS, &mechanics.data.axis_steps_per_mm[E_AXIS + 3], 5, 9999, _mechanics_refresh_e3_positioning);
          #if EXTRUDERS > 4
            MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float5, MSG_E5STEPS, &mechanics.data.axis_steps_per_mm[E_AXIS + 4], 5, 9999, _mechanics_refresh_e4_positioning);
            #if EXTRUDERS > 5
              MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float5, MSG_E6STEPS, &mechanics.data.axis_steps_per_mm[E_AXIS + 5], 5, 9999, _mechanics_refresh_e4_positioning);
            #endif // EXTRUDERS > 5
          #endif // EXTRUDERS > 4
        #endif // EXTRUDERS > 3
      #endif // EXTRUDERS > 2
    #else
      MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float5, MSG_ESTEPS, &mechanics.data.axis_steps_per_mm[E_AXIS], 5, 9999, _mechanics_refresh_positioning);
    #endif
