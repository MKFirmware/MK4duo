...
void menu_mmu2_choose_filament() {
  ...
  #endif
  ACTION_ITEM(MSG_MMU2_FILAMENT0, action_mmu2_choose_0);
  ACTION_ITEM(MSG_MMU2_FILAMENT1, action_mmu2_choose_1);
  ACTION_ITEM(MSG_MMU2_FILAMENT2, action_mmu2_choose_2);
  ACTION_ITEM(MSG_MMU2_FILAMENT3, action_mmu2_choose_3);
  ACTION_ITEM(MSG_MMU2_FILAMENT4, action_mmu2_choose_4);
  END_MENU();
}
