...
class MenuItem_back {
  public:
    static inline void action(PGM_P const=nullptr) { lcdui.goto_previous_screen(); }
};
...
#define MENU_MULTIPLIER_ITEM_EDIT_CALLBACK_INDEX(TYPE, LABEL, V...) _MENU_ITEM_VARIANT_P(TYPE,  _edit,  true,   LABEL,        ##V)
