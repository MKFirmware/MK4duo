...
#else
  #define LCD_Z_OFFSET_FUNC(N)  ftostr53sign(N)
...
//                          TYPE      NAME      FIX   STRFUNC       SCALE       +ROUND
DEFINE_MENU_EDIT_ITEM_TYPE(uint8_t  ,percent    ,0  ,ui8tostr4pct , 100.f/255.f ,0.5f );  // 100%       right-justified
...
DEFINE_MENU_EDIT_ITEM_TYPE(uint16_t ,uint16_4   ,0  ,ui16tostr4   ,   0.1f            );  // 1234       right-justified
DEFINE_MENU_EDIT_ITEM_TYPE(uint16_t ,uint16_5   ,0  ,ui16tostr5   ,   0.01f           );  // 12345      right-justified
DEFINE_MENU_EDIT_ITEM_TYPE(float    ,float3     ,1  ,ftostr3      ,   1               );  // 123        right-justified
DEFINE_MENU_EDIT_ITEM_TYPE(float    ,float42_52 ,1  ,ftostr42_52  , 100               );  // _2.34, 12.34, -2.34 or 123.45, -23.45
