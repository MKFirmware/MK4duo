  ...
  //
    ...
    MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(int3, MSG_NOZZLE MSG_N2, &hotends[1].target_temperature, 0, hotends[1].data.maxtemp - 10, watch_temp_callback_H1);
      ...
      MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(int3, MSG_NOZZLE MSG_N3, &hotends[2].target_temperature, 0, hotends[2].data.maxtemp - 10, watch_temp_callback_H2);
        ...
        #if HOTENDS > 4
          MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(int3, MSG_NOZZLE MSG_N5, &hotends[4].target_temperature, 0, hotends[4].data.maxtemp - 10, watch_temp_callback_E4);
          #if HOTENDS > 5
            MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(int3, MSG_NOZZLE MSG_N6, &hotends[5].target_temperature, 0, hotends[5].data.maxtemp - 10, watch_temp_callback_E5);
          #endif // HOTENDS > 5
        #endif // HOTENDS > 4
      #endif // HOTENDS > 3
    #endif // HOTENDS > 2
