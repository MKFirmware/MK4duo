...
#if IS_KINEMATIC
  #define MSG_VX_JERK                       _UxGT("Va-skok")
  #define MSG_VY_JERK                       _UxGT("Vb-skok")
  #define MSG_VZ_JERK                       _UxGT("Vc-skok")
#else
...
#if IS_KINEMATIC
  #define MSG_XSTEPS                        _UxGT("Akrokov/mm")
  #define MSG_YSTEPS                        _UxGT("Bkrokov/mm")
  #define MSG_ZSTEPS                        _UxGT("Ckrokov/mm")
#else
