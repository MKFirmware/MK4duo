...
#define MSG_FILAMENT_CHANGE_OPTION_PURGE    _UxGT("Extrudeer meer")
...
//
  ...
  #define MSG_FILAMENT_CHANGE_PURGE_1         _UxGT("Wacht voor")
  #define MSG_FILAMENT_CHANGE_PURGE_2         _UxGT("filament te")
  #define MSG_FILAMENT_CHANGE_PURGE_3         _UxGT("extruderen")
  ...
  #define MSG_FILAMENT_CHANGE_PURGE_1         _UxGT("Wacht voor")
  #define MSG_FILAMENT_CHANGE_PURGE_2         _UxGT("extrudering")
