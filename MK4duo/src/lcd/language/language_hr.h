...
#define MSG_FILAMENT_CHANGE_OPTION_PURGE  _UxGT("Extrudiraj više")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Nastavi print")
  ...
  #define MSG_FILAMENT_CHANGE_PURGE_1       _UxGT("Pričekaj")
  ...
  #define MSG_FILAMENT_CHANGE_PURGE_1       _UxGT("Extrudiranje...")
