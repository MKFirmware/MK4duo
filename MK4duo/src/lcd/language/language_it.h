...
#define MSG_FILAMENT_UNLOAD                 _UxGT("Scarica mm")
...
#define MSG_FILAMENTUNLOAD                  _UxGT("Scarica filamento")
...
#define MSG_FILAMENT_CHANGE_HEADER_LOAD     _UxGT("CARICA FILO")
#define MSG_FILAMENT_CHANGE_HEADER_UNLOAD   _UxGT("SCARICA FILO")
...
#define MSG_FILAMENT_CHANGE_NOZZLE          _UxGT("  Ugello: ")
  ...
  #define MSG_FILAMENT_CHANGE_PURGE_2       _UxGT("l'estrusione")
  ...
  #define MSG_FILAMENT_CHANGE_PURGE_1       _UxGT("Estrusione...")
