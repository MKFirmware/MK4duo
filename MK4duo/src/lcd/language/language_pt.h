...
#if IS_KINEMATIC
  #define MSG_VX_JERK                       "Va-jerk"
  #define MSG_VY_JERK                       "Vb-jerk"
  #define MSG_VZ_JERK                       "Vc-jerk"
#else
...
#if IS_KINEMATIC
  #define MSG_XSTEPS                        "A passo/mm"
  #define MSG_YSTEPS                        "B passo/mm"
  #define MSG_ZSTEPS                        "C passo/mm"
#else
