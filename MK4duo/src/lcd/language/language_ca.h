...
#define MSG_FILAMENT_CHANGE_OPTION_PURGE    _UxGT("Extrudeix mes")
...
//
  ...
  #define MSG_FILAMENT_CHANGE_PURGE_1         _UxGT("Esperant per")
  #define MSG_FILAMENT_CHANGE_PURGE_2         _UxGT("extreure filament")
  ...
  #define MSG_FILAMENT_CHANGE_PURGE_1         _UxGT("Extrudint...")
