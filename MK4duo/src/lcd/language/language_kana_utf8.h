...
#define MSG_FILAMENT_CHANGE_OPTION_PURGE  _UxGT("サラニオシダス")                 // "Extrude more"
...
#define MSG_FILAMENT_CHANGE_PURGE_1       _UxGT("フィラメントオシダシチュウ")          // "Wait for"
#define MSG_FILAMENT_CHANGE_PURGE_2       _UxGT("シバラクオマチクダサイ")            // "filament extrude"
