...
#define MSG_FILAMENT_CHANGE_OPTION_PURGE  _UxGT("Ekstruduj więcej")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Wznów drukowanie")
  ...
  #define MSG_FILAMENT_CHANGE_PURGE_2       _UxGT("ekstruzję filamentu")
  ...
  #define MSG_FILAMENT_CHANGE_PURGE_1       _UxGT("Ekstruzja...")
