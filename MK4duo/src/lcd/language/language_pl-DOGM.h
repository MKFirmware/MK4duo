...
#if IS_KINEMATIC
  #define MSG_VX_JERK                       _UxGT("Zryw Va")
  #define MSG_VY_JERK                       _UxGT("Zryw Vb")
  #define MSG_VZ_JERK                       _UxGT("Zryw Vc")
#else
...
#if IS_KINEMATIC
  #define MSG_XSTEPS                        _UxGT("krokiA/mm")
  #define MSG_YSTEPS                        _UxGT("krokiB/mm")
  #define MSG_ZSTEPS                        _UxGT("krokiC/mm")
#else
