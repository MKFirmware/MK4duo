...
#define MSG_FILAMENT_CHANGE_OPTION_PURGE  _UxGT("Extruder mere")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Forsæt print")
  ...
  #define MSG_FILAMENT_CHANGE_PURGE_1       _UxGT("Vent på")
  #define MSG_FILAMENT_CHANGE_PURGE_2       _UxGT("filament extrudering")
  ...
  #define MSG_FILAMENT_CHANGE_PURGE_1       _UxGT("Extrudere...")
