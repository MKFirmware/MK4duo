...
{
  public:
    U8GLIB_64128N_2X_HAL(pin_t sck, pin_t mosi, pin_t cs, pin_t a0, uint8_t reset = U8G_PIN_NONE)
      : U8GLIB(&u8g_dev_st7565_64128n_HAL_2x_sw_spi, sck, mosi, cs, a0, reset)
      { }
    U8GLIB_64128N_2X_HAL(pin_t cs, pin_t a0, uint8_t reset = U8G_PIN_NONE)
...
{
  public:
    U8GLIB_ST7920_128X64_4X_HAL(pin_t sck, pin_t mosi, pin_t cs, uint8_t reset = U8G_PIN_NONE)
      : U8GLIB(&u8g_dev_st7920_128x64_HAL_4x_sw_spi, sck, mosi, cs, U8G_PIN_NONE, reset)    // a0 = U8G_PIN_NONE
      { }
    U8GLIB_ST7920_128X64_4X_HAL(pin_t cs, uint8_t reset = U8G_PIN_NONE)
...
{
  public:
    U8GLIB_ST7920_128X64_RRD(pin_t sck, pin_t mosi, pin_t cs, uint8_t reset = U8G_PIN_NONE)
