...
namespace language_es {
  ...
  FSTRINGVALUE(MSG_PREHEAT_1_END_E                  , _UxGT("Precalentar ") PREHEAT_1_LABEL _UxGT(" Fin ~"));
  ...
  FSTRINGVALUE(MSG_PREHEAT_2_END_E                  , _UxGT("Precalentar ") PREHEAT_2_LABEL _UxGT(" Fin ~"));
  ...
  FSTRINGVALUE(MSG_FLOW_N                           , _UxGT("Flujo ~"));
  ...
  FSTRINGVALUE(MSG_WATCH                            , _UxGT("Pantalla de Inf."));
  ...
  FSTRINGVALUE(MSG_MMU2_EJECT_FILAMENT_N            , _UxGT("Expulsar Filamento ~"));
  ...
  FSTRINGVALUE(MSG_MMU2_FILAMENT_N                  , _UxGT("Filamento ~"));
