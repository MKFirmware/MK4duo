...
#define MSG_PREHEAT_1_ALL                   MSG_PREHEAT_1_N _UxGT("všetko")
#define MSG_PREHEAT_1_END                   MSG_PREHEAT_1_N _UxGT("hotend")
#define MSG_PREHEAT_1_BEDONLY               MSG_PREHEAT_1_N _UxGT("podlož")
#define MSG_PREHEAT_1_SETTINGS              MSG_PREHEAT_1_N _UxGT("nast.")
#define MSG_PREHEAT_2                       _UxGT("Zahriať " PREHEAT_2_LABEL)
#define MSG_PREHEAT_2_N                     MSG_PREHEAT_2 _UxGT(" ")
#define MSG_PREHEAT_2_ALL                   MSG_PREHEAT_2_N _UxGT("všetko")
#define MSG_PREHEAT_2_END                   MSG_PREHEAT_2_N _UxGT("hotend")
#define MSG_PREHEAT_2_BEDONLY               MSG_PREHEAT_2_N _UxGT("podlož")
#define MSG_PREHEAT_2_SETTINGS              MSG_PREHEAT_2_N _UxGT("nast.")
#define MSG_PREHEAT_3                       _UxGT("Zahriať " PREHEAT_3_LABEL)
#define MSG_PREHEAT_3_N                     MSG_PREHEAT_3 _UxGT(" ")
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3_N _UxGT("všetko")
#define MSG_PREHEAT_3_END                   MSG_PREHEAT_3_N _UxGT("hotend")
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3_N _UxGT("podlož")
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3_N _UxGT("nast.")
...
#define MSG_DXC_MENU                        _UxGT("DXC mód")
#define MSG_DXC_MODE_AUTOPARK               _UxGT("Auto-parkovanie")
#define MSG_DXC_MODE_DUPLICATE              _UxGT("Duplikácia")
#define MSG_DXC_MODE_SCALED_COPY            _UxGT("Zmenšená kópia")
#define MSG_DXC_MODE_FULL_CTRL              _UxGT("Plná kontrola")
#define MSG_DXC_X_OFFSET                    _UxGT("2. tryska X")
#define MSG_DXC_Y_OFFSET                    _UxGT("2. tryska Y")
#define MSG_DXC_Z_OFFSET                    _UxGT("2. tryska Z")
#define MSG_DXC_SAVE_OFFSETS                _UxGT("Uložiť offsety")
...
#define MSG_BLTOUCH_MODE_SW                 _UxGT("SW vysun. BLTouch")
#define MSG_BLTOUCH_MODE_5V                 _UxGT("BLTouch režim 5V")
#define MSG_BLTOUCH_MODE_OD                 _UxGT("BLTouch režim OD")
