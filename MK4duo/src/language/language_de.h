...
#define MSG_PREHEAT_1_N                     _UxGT("Vorw. " PREHEAT_1_LABEL " ")
#define MSG_PREHEAT_1_ALL                   MSG_PREHEAT_1_N _UxGT("Alles")
#define MSG_PREHEAT_1_END                   MSG_PREHEAT_1_N _UxGT("Extr.")
#define MSG_PREHEAT_1_BEDONLY               MSG_PREHEAT_1_N _UxGT("Bett")
#define MSG_PREHEAT_1_SETTINGS              MSG_PREHEAT_1_N _UxGT("Einst.")
#define MSG_PREHEAT_2                       _UxGT("Vorwärmen " PREHEAT_2_LABEL)
#define MSG_PREHEAT_2_N                     _UxGT("Vorw. " PREHEAT_2_LABEL " ")
#define MSG_PREHEAT_2_ALL                   MSG_PREHEAT_2_N _UxGT("Alles")
#define MSG_PREHEAT_2_END                   MSG_PREHEAT_2_N _UxGT("Extr.")
#define MSG_PREHEAT_2_BEDONLY               MSG_PREHEAT_2_N _UxGT("Bett")
#define MSG_PREHEAT_2_SETTINGS              MSG_PREHEAT_2_N _UxGT("Einst.")
#define MSG_PREHEAT_3                       _UxGT("Vorwärmen " PREHEAT_3_LABEL)
#define MSG_PREHEAT_3_N                     _UxGT("Vorw. " PREHEAT_3_LABEL " ")
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3_N _UxGT("Alles")
#define MSG_PREHEAT_3_END                   MSG_PREHEAT_3_N _UxGT("Extr.")
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3_N _UxGT("Bett")
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3_N _UxGT("Einst.")
...
#define MSG_DXC_MENU                        _UxGT("DXC-Modus")
#define MSG_DXC_MODE_AUTOPARK               _UxGT("Autom. Parken")
#define MSG_DXC_MODE_DUPLICATE              _UxGT("Duplizieren")
#define MSG_DXC_MODE_SCALED_COPY            _UxGT("Skalierung kopieren")
#define MSG_DXC_MODE_FULL_CTRL              _UxGT("vollstä. Kontrolle")
#define MSG_DXC_X_OFFSET                    _UxGT("2. Düse X")
#define MSG_DXC_Y_OFFSET                    _UxGT("2. Düse Y")
#define MSG_DXC_Z_OFFSET                    _UxGT("2. Düse Z")
#define MSG_DXC_SAVE_OFFSETS                _UxGT("Versätze speichern")
