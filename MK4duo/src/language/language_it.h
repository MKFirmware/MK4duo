...
#define MSG_PREHEAT_3                       _UxGT("Preriscalda " PREHEAT_3_LABEL)
#define MSG_PREHEAT_3_N                     _UxGT("Preris. " PREHEAT_3_LABEL)
...
#define MSG_NEXT_CORNER                     _UxGT("Prossimo angolo")
...
#define MSG_DXC_MODE_MIRRORED_COPY          _UxGT("Copia speculare")
...
#define MSG_FILAMENT_SWAP_LENGTH            _UxGT("Dist. swap")
#define MSG_FILAMENT_PURGE_LENGTH           _UxGT("Dist. pulizia")
#define MSG_TOOL_CHANGE                     _UxGT("Cambio utensile")
#define MSG_TOOL_CHANGE_ZLIFT               _UxGT("Risalita Z")
#define MSG_SINGLENOZZLE_PRIME_SPD          _UxGT("Velocita' pulizia")
#define MSG_SINGLENOZZLE_RETRACT_SPD        _UxGT("Velocita' retrazione")
...
#define MSG_BLTOUCH_SELFTEST                _UxGT("Autotest")
#define MSG_BLTOUCH_RESET                   _UxGT("Resetta")
#define MSG_BLTOUCH_DEPLOY                  _UxGT("Estendi")
#define MSG_BLTOUCH_MODE_SW                 _UxGT("Modo SW")
#define MSG_BLTOUCH_MODE_5V                 _UxGT("Modo 5V")
#define MSG_BLTOUCH_MODE_OD                 _UxGT("Modo OD")
#define MSG_BLTOUCH_MODE_STORE              _UxGT("Mode Store")
#define MSG_BLTOUCH_STOW                    _UxGT("Ritrai")
#define MSG_BLTOUCH_MODE_STORE_5V           _UxGT("Setta a 5V")
#define MSG_BLTOUCH_MODE_STORE_OD           _UxGT("Setta a OD")
#define MSG_BLTOUCH_MODE_ECHO               _UxGT("Report Drain")
#define MSG_BLTOUCH_MODE_CHANGE             _UxGT("PERICOLO: Impostazioni errate possono causare danni! Procedere comunque?")
#define MSG_MANUAL_DEPLOY                   _UxGT("Estendi Probe")
#define MSG_MANUAL_STOW                     _UxGT("Ritrai Probe")
...
#define MSG_INFO_BEDS                       _UxGT("Letti")
#define MSG_INFO_CHAMBERS                   _UxGT("Camere calde")
...
#define MSG_EXPECTED_PRINTER                _UxGT("Stampante errata")
  ...
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Completate")
  #define MSG_INFO_PRINT_TIME               _UxGT("Tempo totale")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Stampa piu' lunga")
  #define MSG_INFO_POWER_ON                 _UxGT("Accesa per tempo")
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("Filamento usato")
#else
  #define MSG_INFO_PRINT_COUNT              _UxGT("Stampe")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Completate")
  #define MSG_INFO_PRINT_TIME               _UxGT("Tempo tot.")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Piu' lunga")
  #define MSG_INFO_POWER_ON                 _UxGT("Accesa per")
...
#define MSG_MMU2_LOAD_TO_NOZZLE             _UxGT("Carica ugello")
