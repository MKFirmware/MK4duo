...
#define MSG_BLTOUCH_MODE_SW                 _UxGT("BLTouch modo SW")
#define MSG_BLTOUCH_MODE_5V                 _UxGT("BLTouch modo 5V")
#define MSG_BLTOUCH_MODE_OD                 _UxGT("BLTouch modo OD")
#define MSG_BLTOUCH_MODE_STORE              _UxGT("BLTouch Mode Store")
#define MSG_BLTOUCH_STOW                    _UxGT("Ritrai BLTouch")
#define MSG_BLTOUCH_MODE_STORE_5V           _UxGT("Setta BLTouch a 5V")
#define MSG_BLTOUCH_MODE_STORE_OD           _UxGT("Setta BLTouch a OD")
