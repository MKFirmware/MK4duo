...
namespace Language_it {
  ...
  FSTRINGVALUE(MSG_WATCH                            , _UxGT("Schermata info"));
  ...
  FSTRINGVALUE(MSG_MMU2_EJECT_FILAMENT0             , _UxGT("Espelli filam.1"));
  FSTRINGVALUE(MSG_MMU2_EJECT_FILAMENT1             , _UxGT("Espelli filam.2"));
  FSTRINGVALUE(MSG_MMU2_EJECT_FILAMENT2             , _UxGT("Espelli filam.3"));
  FSTRINGVALUE(MSG_MMU2_EJECT_FILAMENT3             , _UxGT("Espelli filam.4"));
  FSTRINGVALUE(MSG_MMU2_EJECT_FILAMENT4             , _UxGT("Espelli filam.5"));
  ...
  FSTRINGVALUE(MSG_MMU2_FILAMENT0                   , _UxGT("Filamento 1"));
  FSTRINGVALUE(MSG_MMU2_FILAMENT1                   , _UxGT("Filamento 2"));
  FSTRINGVALUE(MSG_MMU2_FILAMENT2                   , _UxGT("Filamento 3"));
  FSTRINGVALUE(MSG_MMU2_FILAMENT3                   , _UxGT("Filamento 4"));
  FSTRINGVALUE(MSG_MMU2_FILAMENT4                   , _UxGT("Filamento 5"));
