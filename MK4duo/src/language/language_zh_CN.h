...
#define MSG_PREHEAT_1                       _UxGT("预热" PREHEAT_1_LABEL)  //"Preheat PREHEAT_1_LABEL"
#define MSG_PREHEAT_1_N                     MSG_PREHEAT_1 _UxGT(" ")  //MSG_PREHEAT_1 " "
#define MSG_PREHEAT_1_ALL                   MSG_PREHEAT_1_N _UxGT("全部")  //MSG_PREHEAT_1_N "All"
#define MSG_PREHEAT_1_END                   MSG_PREHEAT_1_N _UxGT("挤出机") //MSG_PREHEAT_1_N "Extruder"
#define MSG_PREHEAT_1_BEDONLY               MSG_PREHEAT_1_N _UxGT("热床")  //MSG_PREHEAT_1_N "Bed"
#define MSG_PREHEAT_1_SETTINGS              MSG_PREHEAT_1_N _UxGT("设置")  //MSG_PREHEAT_1_N "conf"
...
#define MSG_PREHEAT_2_ALL                   MSG_PREHEAT_2_N _UxGT("全部")  //MSG_PREHEAT_2_N "All"
#define MSG_PREHEAT_2_END                   MSG_PREHEAT_2_N _UxGT("挤出机") //MSG_PREHEAT_2_N "Extruder"
#define MSG_PREHEAT_2_BEDONLY               MSG_PREHEAT_2_N _UxGT("热床")  //MSG_PREHEAT_2_N "Bed"
#define MSG_PREHEAT_2_SETTINGS              MSG_PREHEAT_2_N _UxGT("设置")  //MSG_PREHEAT_2_N "conf"
#define MSG_PREHEAT_3                       _UxGT("预热" PREHEAT_3_LABEL)  //"Preheat PREHEAT_3_LABEL"
#define MSG_PREHEAT_3_N                     MSG_PREHEAT_3 _UxGT(" ")  //MSG_PREHEAT_3 " "
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3_N _UxGT("全部")  //MSG_PREHEAT_3_N "All"
#define MSG_PREHEAT_3_END                   MSG_PREHEAT_3_N _UxGT("挤出机") //MSG_PREHEAT_3_N "Extruder"
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3_N _UxGT("热床")  //MSG_PREHEAT_3_N "Bed"
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3_N _UxGT("设置")  //MSG_PREHEAT_3_N "conf"
#define MSG_PREHEAT_CUSTOM                  _UxGT("预热定制") //"Preheat custom"
