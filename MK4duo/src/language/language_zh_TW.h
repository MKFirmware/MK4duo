...
#define MSG_PREHEAT_1_END                   MSG_PREHEAT_1_N _UxGT("擠出機") //MSG_PREHEAT_1_N "Extruder"
#define MSG_PREHEAT_1_BEDONLY               MSG_PREHEAT_1_N _UxGT("熱床")  //MSG_PREHEAT_1_N "Bed"
#define MSG_PREHEAT_1_SETTINGS              MSG_PREHEAT_1_N _UxGT("設置")  //MSG_PREHEAT_1_N "conf"
...
#define MSG_PREHEAT_2_END                   MSG_PREHEAT_2_N _UxGT("擠出機") //MSG_PREHEAT_2_N "Extruder"
#define MSG_PREHEAT_2_BEDONLY               MSG_PREHEAT_2_N _UxGT("熱床")  //MSG_PREHEAT_2_N "Bed"
#define MSG_PREHEAT_2_SETTINGS              MSG_PREHEAT_2_N _UxGT("設置")  //MSG_PREHEAT_2_N "conf"
#define MSG_PREHEAT_3                       _UxGT("預熱" PREHEAT_3_LABEL)  //"Preheat PREHEAT_3_LABEL"
...
#define MSG_PREHEAT_3_END                   MSG_PREHEAT_3_N _UxGT("擠出機") //MSG_PREHEAT_3_N "Extruder"
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3_N _UxGT("熱床")  //MSG_PREHEAT_3_N "Bed"
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3_N _UxGT("設置")  //MSG_PREHEAT_3_N "conf"
#define MSG_PREHEAT_CUSTOM                  _UxGT("預熱定制") //"Preheat custom"
