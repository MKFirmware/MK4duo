...
#define THIS_LANGUAGES_SPECIAL_SYMBOLS      _UxGT("áÁcCdDéÉeEíÍnNóÓrRšŠtTúÚuUýÝžŽ³")
#define CHARSIZE 2
...
#define MSG_DEBUG_MENU                      _UxGT("Nabídka ladení")
#if LCD_WIDTH >= 20
...
#define MSG_LEVEL_BED_HOMING                _UxGT("Merení podložky")
#define MSG_LEVEL_BED_WAITING               _UxGT("Kliknutím spustte")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("Další bod")
#define MSG_LEVEL_BED_DONE                  _UxGT("Merení hotovo!")
...
#define MSG_PREHEAT_CUSTOM                  _UxGT("Zahrát vlastní")
...
#define MSG_SPINDLE_REVERSE                 _UxGT("Vreteno opacne")
...
#define MSG_EDITING_STOPPED                 _UxGT("Konec úprav síte")
...
#define MSG_OFFSETS_MENU                    _UxGT("Ofsety nástroju")
...
#define MSG_UBL_MANUAL_MESH                 _UxGT("Manuální sít bodu")
#define MSG_UBL_BC_INSERT                   _UxGT("Vložte kartu, zmerte")
...
#define MSG_UBL_GRID_MESH_LEVELING          _UxGT("Mrížkové rovnání")
#define MSG_UBL_MESH_LEVEL                  _UxGT("Srovnat podložku")
#define MSG_UBL_SIDE_POINTS                 _UxGT("Postranní body")
#define MSG_UBL_MAP_TYPE                    _UxGT("Typ síte bodu")
#define MSG_UBL_OUTPUT_MAP                  _UxGT("Exportovat sít")
...
#define MSG_UBL_FILLIN_MESH                 _UxGT("Zaplnit mrížku")
...
#define MSG_UBL_STORAGE_MESH_MENU           _UxGT("Uložište sítí")
#define MSG_UBL_STORAGE_SLOT                _UxGT("Pametový slot")
#define MSG_UBL_LOAD_MESH                   _UxGT("Nacíst sít bodu")
#define MSG_UBL_SAVE_MESH                   _UxGT("Uložit sít bodu")
#define MSG_MESH_LOADED                     _UxGT("Sít %i nactena")
#define MSG_MESH_SAVED                      _UxGT("Sít %i uložena")
...
#define MSG_CUSTOM_LEDS                     _UxGT("Vlastní svetla")
#define MSG_INTENSITY_R                     _UxGT("Cervená intenzita")
...
#define MSG_LOAD_EEPROM                     _UxGT("Nacíst nastavení")
...
#define MSG_TUNE                            _UxGT("Doladení tisku")
...
#define MSG_TOOL_CHANGE                     _UxGT("Výmena nástroje")
...
#define MSG_INIT_MEDIA                      _UxGT("Nacíst SD kartu")
#define MSG_CHANGE_MEDIA                    _UxGT("Vymenit SD kartu")
...
#define MSG_HOME_FIRST                      _UxGT("Domu %s%s%s první")
...
#define MSG_HEATING_FAILED_LCD              _UxGT("Chyba zahrívání")
...
#define MSG_ERR_Z_HOMING                    _UxGT("Domu XY první")
...
#if LCD_WIDTH >= 20
  #define MSG_BED_HEATING                   _UxGT("Zahrívání podložky")
#else
...
#define MSG_INFO_MENU                       _UxGT("O tiskárne")
#define MSG_INFO_PRINTER_MENU               _UxGT("Info o tiskárne")
...
#define MSG_MESH_LEVELING                   _UxGT("Mrížkové rovnání")
...
#define MSG_CASE_LIGHT                      _UxGT("Osvetlení")
#define MSG_CASE_LIGHT_BRIGHTNESS           _UxGT("Jas svetla")
  ...
  #define MSG_INFO_PRINT_TIME               _UxGT("Celkový cas")
...
#define MSG_DRIVE_STRENGTH                  _UxGT("Buzení motoru")
...
#define MSG_FILAMENT_CHANGE_OPTION_PURGE    _UxGT("Vytlacit víc")
...
#define MSG_MMU2_NOT_RESPONDING             _UxGT("MMU potr. pozornost.")
...
#define MSG_MMU2_LOADING_FILAMENT           _UxGT("Zavádení fil. %i...")
...
#define MSG_MMU2_EJECT_RECOVER              _UxGT("Vytáhnete, kliknete")

#define MSG_MIX                             _UxGT("Mix")
#define MSG_MIX_COMPONENT                   _UxGT("Komponenta")
#define MSG_MIXER                           _UxGT("Mixér")
#define MSG_GRADIENT                        _UxGT("Prechod")
#define MSG_FULL_GRADIENT                   _UxGT("Celý prechod")
#define MSG_TOGGLE_MIX                      _UxGT("Prepnout mix")
#define MSG_CYCLE_MIX                       _UxGT("Strídat mix")
#define MSG_GRADIENT_MIX                    _UxGT("Prechod mix")
#define MSG_REVERSE_GRADIENT                _UxGT("Opacný prechod")
#if LCD_WIDTH >= 20
  #define MSG_ACTIVE_VTOOL                    _UxGT("Aktivní V-nástroj")
  #define MSG_START_VTOOL                     _UxGT("Spustit V-nástroj")
  #define MSG_END_VTOOL                       _UxGT("Ukoncit V-nástroj")
  ...
  #define MSG_END_VTOOL                       _UxGT("Ukoncit V-nástr.")
...
#endif
#define MSG_START_Z                         _UxGT("Pocátecní Z")
...
#define MSG_EXPECTED_PRINTER                _UxGT("Nesprávná tiskárna")
  ...
  #define MSG_FILAMENT_CHANGE_INIT_1        _UxGT("Cekejte prosím")
  ...
  #define MSG_FILAMENT_CHANGE_INSERT_3      _UxGT("tlacítko...")
  #define MSG_FILAMENT_CHANGE_HEAT_1        _UxGT("Kliknete pro")
  #define MSG_FILAMENT_CHANGE_HEAT_2        _UxGT("nahrátí trysky")
  #define MSG_FILAMENT_CHANGE_HEATING_1     _UxGT("Cekejte prosím")
  #define MSG_FILAMENT_CHANGE_HEATING_2     _UxGT("na nahrátí tr.")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1      _UxGT("Cekejte prosím")
  #define MSG_FILAMENT_CHANGE_UNLOAD_2      _UxGT("na vysunuti")
  #define MSG_FILAMENT_CHANGE_UNLOAD_3      _UxGT("filamentu")
  #define MSG_FILAMENT_CHANGE_LOAD_1        _UxGT("Cekejte prosím")
  #define MSG_FILAMENT_CHANGE_LOAD_2        _UxGT("na zavedení")
  #define MSG_FILAMENT_CHANGE_LOAD_3        _UxGT("filamentu")
  #define MSG_FILAMENT_CHANGE_PURGE_1       _UxGT("Vyckejte na")
  #define MSG_FILAMENT_CHANGE_PURGE_2       _UxGT("vytlacení")
  #define MSG_FILAMENT_CHANGE_CONT_PURGE_1  _UxGT("Kliknete pro")
  #define MSG_FILAMENT_CHANGE_CONT_PURGE_2  _UxGT("ukoncení")
  #define MSG_FILAMENT_CHANGE_CONT_PURGE_3  _UxGT("vytlacování")
  #define MSG_FILAMENT_CHANGE_RESUME_1      _UxGT("Cekejte prosím")
  #define MSG_FILAMENT_CHANGE_RESUME_2      _UxGT("na pokracování")
  #define MSG_FILAMENT_CHANGE_RESUME_3      _UxGT("tisku")
#else // LCD_HEIGHT < 4
  // Up to 2 lines allowed
  #define MSG_ADVANCED_PAUSE_WAITING_1      _UxGT("Stiknete tlac.")
  #define MSG_ADVANCED_PAUSE_WAITING_2      _UxGT("pro obnovení")
  #define MSG_PAUSE_PRINT_INIT_1            _UxGT("Parkování...")
  #define MSG_FILAMENT_CHANGE_INIT_1        _UxGT("Cekejte...")
  #define MSG_FILAMENT_CHANGE_INSERT_1      _UxGT("Vložte, kliknete")
  #define MSG_FILAMENT_CHANGE_HEAT_1        _UxGT("Kliknete pro")
  #define MSG_FILAMENT_CHANGE_HEAT_2        _UxGT("nahrátí")
  #define MSG_FILAMENT_CHANGE_HEATING_1     _UxGT("Nahrívání...")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1      _UxGT("Vysouvání...")
  #define MSG_FILAMENT_CHANGE_LOAD_1        _UxGT("Zavádení...")
...
#define MSG_TMC_DRIVERS                     _UxGT("TMC budice")
#define MSG_TMC_CURRENT                     _UxGT("Proud budicu")
#define MSG_TMC_HYBRID_THRS                 _UxGT("Hybridní práh")
#define MSG_TMC_HOMING_THRS                 _UxGT("Domu bez senzoru")
#define MSG_TMC_STEPPING_MODE               _UxGT("Režim kroku")
...
#define MSG_BACKLASH                        _UxGT("Vule")
