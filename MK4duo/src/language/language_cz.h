...
namespace language_cz {
  ...
  FSTRINGVALUE(MSG_PREHEAT_1_H                      , _UxGT("Zahrát ") PREHEAT_1_LABEL " ~");
  FSTRINGVALUE(MSG_PREHEAT_1_END                    , _UxGT("Zahrát ") PREHEAT_1_LABEL _UxGT(" end"));
  FSTRINGVALUE(MSG_PREHEAT_1_END_E                  , _UxGT("Zahrát ") PREHEAT_1_LABEL _UxGT(" end ~"));
  ...
  FSTRINGVALUE(MSG_PREHEAT_2_H                      , _UxGT("Zahrát ") PREHEAT_2_LABEL " ~");
  FSTRINGVALUE(MSG_PREHEAT_2_END                    , _UxGT("Zahrát ") PREHEAT_2_LABEL _UxGT(" end"));
  FSTRINGVALUE(MSG_PREHEAT_2_END_E                  , _UxGT("Zahrát ") PREHEAT_2_LABEL _UxGT(" end ~"));
  ...
  FSTRINGVALUE(MSG_FLOW_N                           , _UxGT("Prutok ~"));
  ...
  FSTRINGVALUE(MSG_MMU2_EJECT_FILAMENT_N            , _UxGT("Vysun. filament ~"));
  ...
  FSTRINGVALUE(MSG_MIX_COMPONENT_N                  , _UxGT("Komponenta ~"));
