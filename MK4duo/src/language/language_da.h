...
#define MSG_PREHEAT_1_N                     _UxGT("Forv. " PREHEAT_1_LABEL " ")
#define MSG_PREHEAT_1_ALL                   MSG_PREHEAT_1_N _UxGT("Alle")
#define MSG_PREHEAT_1_END                   MSG_PREHEAT_1_N _UxGT("Ekstr.")
...
#define MSG_PREHEAT_2_N                     _UxGT("Forv. " PREHEAT_2_LABEL " ")
#define MSG_PREHEAT_2_ALL                   MSG_PREHEAT_2_N _UxGT("Alle")
#define MSG_PREHEAT_2_END                   MSG_PREHEAT_2_N _UxGT("Ekstr.")
#define MSG_PREHEAT_2_BEDONLY               MSG_PREHEAT_2_N _UxGT("Bed")
#define MSG_PREHEAT_2_SETTINGS              MSG_PREHEAT_2_N _UxGT("conf")
#define MSG_PREHEAT_3                       _UxGT("Forvarm " PREHEAT_3_LABEL)
#define MSG_PREHEAT_3_N                     _UxGT("Forv. " PREHEAT_3_LABEL " ")
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3_N _UxGT("Alle")
#define MSG_PREHEAT_3_END                   MSG_PREHEAT_3_N _UxGT("Ekstr.")
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3_N _UxGT("Bed")
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3_N _UxGT("conf")
#define MSG_PREHEAT_CUSTOM                  _UxGT("Brugerdef. forvarm")
