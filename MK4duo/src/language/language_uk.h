...
#define MSG_PREHEAT_1_ALL                   MSG_PREHEAT_1_N _UxGT("Все")
#define MSG_PREHEAT_1_END                   MSG_PREHEAT_1_N _UxGT("Екструдер")
#define MSG_PREHEAT_1_BEDONLY               MSG_PREHEAT_1_N _UxGT("Стіл")
#define MSG_PREHEAT_1_SETTINGS              MSG_PREHEAT_1_N _UxGT("нал.")
#define MSG_PREHEAT_2                       _UxGT("Нагрів " PREHEAT_2_LABEL)
#define MSG_PREHEAT_2_N                     MSG_PREHEAT_2 _UxGT(" ")
#define MSG_PREHEAT_2_ALL                   MSG_PREHEAT_2_N _UxGT("Все")
#define MSG_PREHEAT_2_END                   MSG_PREHEAT_2_N _UxGT("Екструдер")
#define MSG_PREHEAT_2_BEDONLY               MSG_PREHEAT_2_N _UxGT("Стіл")
#define MSG_PREHEAT_2_SETTINGS              MSG_PREHEAT_2_N _UxGT("нал.")
#define MSG_PREHEAT_3                       _UxGT("Нагрів " PREHEAT_3_LABEL)
#define MSG_PREHEAT_3_N                     MSG_PREHEAT_3 _UxGT(" ")
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3_N _UxGT("Все")
#define MSG_PREHEAT_3_END                   MSG_PREHEAT_3_N _UxGT("Екструдер")
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3_N _UxGT("Стіл")
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3_N _UxGT("нал.")
#define MSG_PREHEAT_CUSTOM                  _UxGT("Підігріти звичай")
