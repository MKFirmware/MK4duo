...
namespace language_el {
  ...
  FSTRINGVALUE(LANGUAGE                             , _UxGT("Greek"));
  ...
  FSTRINGVALUE(MSG_DISABLE_STEPPERS                 , _UxGT("Απενεργοποίηση Μοτέρ"));
  FSTRINGVALUE(MSG_AUTO_HOME                        , _UxGT("Αυτομ. επαναφορά στο αρχικό σημείο")); //SHORTEN
  ...
  FSTRINGVALUE(MSG_LEVEL_BED_HOMING                 , _UxGT("Επαναφορά Επ. Εκτύπωσης")); //SHORTEN
  FSTRINGVALUE(MSG_LEVEL_BED_WAITING                , _UxGT("Επιπεδοποίηση επ. Εκτύπωσης περιμενει")); //SHORTEN
  FSTRINGVALUE(MSG_LEVEL_BED_NEXT_POINT             , _UxGT("Επόμενο σημείο"));
  FSTRINGVALUE(MSG_LEVEL_BED_DONE                   , _UxGT("Ολοκλήρωση επιπεδοποίησης!")); //SHORTEN
  FSTRINGVALUE(MSG_SET_HOME_OFFSETS                 , _UxGT("Ορισμός βασικών μετατοπίσεων")); //SHORTEN
  FSTRINGVALUE(MSG_HOME_OFFSETS_APPLIED             , _UxGT("Εφαρμόστηκαν οι μετατοπίσεις")); //SHORTEN
  ...
  FSTRINGVALUE(MSG_PREHEAT_1_BEDONLY                , _UxGT("Προθέρμανση ") PREHEAT_1_LABEL _UxGT(" bed")); //SHORTEN
  FSTRINGVALUE(MSG_PREHEAT_1_SETTINGS               , _UxGT("Προθέρμανση ") PREHEAT_1_LABEL _UxGT(" επιβεβαίωση")); //SHORTEN
  FSTRINGVALUE(MSG_PREHEAT_2                        , _UxGT("Προθέρμανση ") PREHEAT_2_LABEL);
  FSTRINGVALUE(MSG_PREHEAT_2_H0                     , _UxGT("Προθέρμανση ") PREHEAT_2_LABEL " ~");
  ...
  FSTRINGVALUE(MSG_PREHEAT_2_BEDONLY                , _UxGT("Προθέρμανση ") PREHEAT_2_LABEL _UxGT(" bed")); //SHORTEN
  FSTRINGVALUE(MSG_PREHEAT_2_SETTINGS               , _UxGT("Προθέρμανση ") PREHEAT_2_LABEL _UxGT(" επιβεβαίωση")); //SHORTEN
  ...
  FSTRINGVALUE(MSG_BED_LEVELING                     , _UxGT("Επιπεδοποίηση Επ. Εκτύπωσης")); //SHORTEN
  FSTRINGVALUE(MSG_LEVEL_BED                        , _UxGT("Επιπεδοποίηση Επ. Εκτύπωσης")); //SHORTEN
  ...
  FSTRINGVALUE(MSG_BED_Z                            , _UxGT("Επ. Εκτύπωσης Z"));
  ...
  FSTRINGVALUE(MSG_AUTOTEMP                         , _UxGT("Αυτομ ρύθμιση θερ/σίας")); //SHORTEN
  ...
  FSTRINGVALUE(MSG_VMAX_A                           , _UxGT("V Μέγιστο") LCD_STR_A);
  FSTRINGVALUE(MSG_VMAX_B                           , _UxGT("V Μέγιστο") LCD_STR_B);
  FSTRINGVALUE(MSG_VMAX_C                           , _UxGT("V Μέγιστο") LCD_STR_C);
  FSTRINGVALUE(MSG_VMAX_E                           , _UxGT("V Μέγιστο") LCD_STR_E);
  FSTRINGVALUE(MSG_VMAX_EN                          , _UxGT("V Μέγιστο *"));
  FSTRINGVALUE(MSG_VMIN                             , _UxGT("V Ελάχιστο"));
  ...
  FSTRINGVALUE(MSG_RESTORE_FAILSAFE                 , _UxGT("Επαναφορά ασφαλούς αντιγράφου")); //SHORTEN
  FSTRINGVALUE(MSG_REFRESH                          , LCD_STR_REFRESH  _UxGT("Ανανέωση"));
  FSTRINGVALUE(MSG_WATCH                            , _UxGT("Οθόνη πληροφόρησης"));
  ...
  FSTRINGVALUE(MSG_PRINT_ABORTED                    , _UxGT("Διακόπτεται η εκτύπωση")); //SHORTEN
  ...
  FSTRINGVALUE(MSG_CONTROL_RETRACT_SWAP             , _UxGT("Εναλλαγή ανάσυρσης μμ"));  //SHORTEN
  ...
  FSTRINGVALUE(MSG_INIT_MEDIA                       , _UxGT("Προετοιμασία κάρτας SD"));  //SHORTEN
  FSTRINGVALUE(MSG_CHANGE_MEDIA                     , _UxGT("Αλλαγή κάρτας SD"));
  FSTRINGVALUE(MSG_ZPROBE_OUT                       , _UxGT("Διερεύνηση Z εκτός Επ.Εκτύπωσης")); //SHORTEN
  FSTRINGVALUE(MSG_YX_UNHOMED                       , _UxGT("Επαναφορά Χ/Υ πριν από Ζ")); //SHORTEN
  ...
  FSTRINGVALUE(MSG_ENDSTOP_ABORT                    , _UxGT("Ακύρωση endstop "));
  FSTRINGVALUE(MSG_HEATING_FAILED_LCD               , _UxGT("Ανεπιτυχής θέρμανση"));
  FSTRINGVALUE(MSG_ERR_REDUNDANT_TEMP               , _UxGT("ΠΛΕΟΝΑΖΟΥΣΑ ΘΕΡΜΟΤΗΤΑ"));
  FSTRINGVALUE(MSG_THERMAL_RUNAWAY                  , _UxGT("ΔΙΑΦΥΓΗ ΘΕΡΜΟΚΡΑΣΙΑΣ"));
  FSTRINGVALUE(MSG_ERR_MAXTEMP                      , _UxGT("ΠΕΡΙΤΗ ΘΕΡΜΟΚΡΑΣΙΑ"));
  FSTRINGVALUE(MSG_ERR_MINTEMP                      , _UxGT("ΜΗ ΕΠΑΡΚΗΣ ΘΕΡΜΟΚΡΑΣΙΑΣ")); //SHORTEN
  FSTRINGVALUE(MSG_ERR_MAXTEMP_BED                  , _UxGT("ΜΕΓΙΣΤΗ ΘΕΡΜΟΚΡΑΣΙΑΣ ΕΠ. ΕΚΤΥΠΩΣΗΣ")); //SHORTEN
  FSTRINGVALUE(MSG_ERR_MINTEMP_BED                  , _UxGT("ΕΛΑΧΙΣΤΗ ΘΕΡΜΟΚΡΑΣΙΑΣ ΕΠ. ΕΚΤΥΠΩΣΗΣ")); //SHORTEN
  FSTRINGVALUE(MSG_HALTED                           , _UxGT("H εκτύπωση διακόπηκε"));
  FSTRINGVALUE(MSG_HEATING                          , _UxGT("Θερμαίνεται…"));
  FSTRINGVALUE(MSG_BED_HEATING                      , _UxGT("Θέρμανση ΕΠ. Εκτύπωσης")); //SHORTEN
