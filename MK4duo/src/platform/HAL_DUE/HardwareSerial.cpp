...
template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::print(char c, int base) {
    print((long)c, base);
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::print(unsigned char b, int base) {
    print((unsigned long)b, base);
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::print(int n, int base) {
    print((long)n, base);
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::print(unsigned int n, int base) {
    print((unsigned long)n, base);
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::print(long n, int base) {
    if (base == 0) write(n);
    else if (base == 10) {
      if (n < 0) { print('-'); n = -n; }
      printNumber(n, 10);
...
template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::print(unsigned long n, int base) {
    if (base == 0) write(n);
    else printNumber(n, base);
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::print(double n, int digits) {
    printFloat(n, digits);
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::println(void) {
    print('\r');
    print('\n');
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::println(const String& s) {
    print(s);
    println();
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::println(const char c[]) {
    print(c);
    println();
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::println(char c, int base) {
    print(c, base);
    println();
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::println(unsigned char b, int base) {
  print(b, base);
  println();
}

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::println(int n, int base) {
    print(n, base);
    println();
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::println(unsigned int n, int base) {
    print(n, base);
    println();
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::println(long n, int base) {
    print(n, base);
    println();
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::println(unsigned long n, int base) {
    print(n, base);
    println();
  }

template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::println(double n, int digits) {
    print(n, digits);
    println();
  }
...
// Private Methods
template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::printNumber(unsigned long n, uint8_t base) {
    if (n) {
...
template<int portNr, int RX_SIZE, int TX_SIZE>
  void MKHardwareSerial<portNr, RX_SIZE, TX_SIZE>::printFloat(double number, uint8_t digits) {
