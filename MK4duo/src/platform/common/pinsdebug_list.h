...
//
  ...
  #endif
#endif
#if PIN_EXISTS(TEMP_HE0) && TEMP_HE0_PIN < NUM_ANALOG_INPUTS
  REPORT_NAME_ANALOG(__LINE__, TEMP_HE0_PIN)
#endif
#if PIN_EXISTS(TEMP_HE1) && TEMP_HE1_PIN < NUM_ANALOG_INPUTS
  REPORT_NAME_ANALOG(__LINE__, TEMP_HE1_PIN)
#endif
#if PIN_EXISTS(TEMP_HE2) && TEMP_HE2_PIN < NUM_ANALOG_INPUTS
  REPORT_NAME_ANALOG(__LINE__, TEMP_HE2_PIN)
#endif
#if PIN_EXISTS(TEMP_HE3) && TEMP_HE3_PIN < NUM_ANALOG_INPUTS
  REPORT_NAME_ANALOG(__LINE__, TEMP_HE3_PIN)
#endif
...
#endif
#if PIN_EXISTS(HEATER_HE0)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_HE0_PIN)
#endif
#if PIN_EXISTS(HEATER_HE1)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_HE1_PIN)
#endif
#if PIN_EXISTS(HEATER_HE2)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_HE2_PIN)
#endif
#if PIN_EXISTS(HEATER_HE3)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_HE3_PIN)
#endif
#if PIN_EXISTS(HEATER_HE4)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_4_PIN)
#endif
#if PIN_EXISTS(HEATER_HE5)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_5_PIN)
#endif
#if PIN_EXISTS(HEATER_BED0)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_BED0_PIN)
#endif
#if PIN_EXISTS(HEATER_BED1)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_BED1_PIN)
#endif
#if PIN_EXISTS(HEATER_BED2)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_BED2_PIN)
#endif
#if PIN_EXISTS(HEATER_BED3)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_BED3_PIN)
#endif
#if PIN_EXISTS(HEATER_CHAMBER0)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_CHAMBER0_PIN)
#endif
#if PIN_EXISTS(HEATER_CHAMBER1)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_CHAMBER1_PIN)
#endif
#if PIN_EXISTS(HEATER_CHAMBER2)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_CHAMBER2_PIN)
#endif
#if PIN_EXISTS(HEATER_CHAMBER3)
  REPORT_NAME_DIGITAL(__LINE__, HEATER_CHAMBER3_PIN)
#endif
#if PIN_EXISTS(HOME)
